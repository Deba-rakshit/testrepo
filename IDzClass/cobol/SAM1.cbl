      ...
      *
       01  CUST-REC.
           ...
           05  CUST-ORDERS-YTD         PIC S9(5)     COMP.
           05  CUST-ADDR               PIC X(20).
           05  CUST-CITY               PIC X(14).
           05  CUST-STATE              PIC X(02).
           05  CUST-COUNTRY            PIC X(11).
           05  CUST-MONTH              PIC S9(7)V99 COMP-3 OCCURS 12.
           05  CUST-OCCUPATION         PIC X(30).
           05  CUST-NOTES              PIC X(120).
           05  CUST-DATA-1             PIC X(05).
      ...
      *
       01  WS-FIELDS.
           ...
           05  WS-PREV-TRAN-KEY        PIC X(10) VALUE LOW-VALUES.
